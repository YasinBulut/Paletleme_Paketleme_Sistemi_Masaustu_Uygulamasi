...
namespace Proje_1
{
    public partial class FrmMusteriKayit : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("insert into Tbl_Hastalar (MusteriAd,MusteriSoyad,MusteriTc,MusteriTelefon,MusteriSifre,MusteriCinsiyet) values (@p1,@p2,@p3,@p4,@p5,@p6)", bgl.baglanti());
